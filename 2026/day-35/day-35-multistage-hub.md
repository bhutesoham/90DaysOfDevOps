...
- After using `golang:1.25-alpine AS builder` in stage 1 and `scratch` as deployer the image size reduced from 263 MB to 8 MB, hence making it lighweight and fast to load.
