...
- Docker hub link -> `https://hub.docker.com/repository/docker/sohamrb/github-actions-capstone/tags/latest`
...
- A slack notification and multi environment setup would definately help
