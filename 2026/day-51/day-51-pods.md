...
intentionally break your YAML (remove the image field or add an invalid field) and run dry-run again. See what error you get.

Verify: What error does Kubernetes give when the image field is missing?

- client side verification worked but server side verification returned an error when image is removed
